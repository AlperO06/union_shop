...
const List<Product> products = [
  ...
  Product(
    ...
    oldPrice: 17.00,
    newPrice: 10.99,
    image: 'https://www.onudesignerwear.com/images/gucci-crew-nick-logo-sweatshirt-black-1015-p4080-9099_image.jpg',
    description: 'Comfortable classic sweatshirt in neutral tones, perfect for everyday wear.',
    images: [
      'https://www.onudesignerwear.com/images/gucci-crew-nick-logo-sweatshirt-black-1015-p4080-9099_image.jpg',
      'https://www.onudesignerwear.com/images/gucci-junior-gucci-logo-sweatshirt-red-6148-p5676-10685_zoom.jpg',
    ],
    sizes: ['S', 'M', 'L', 'XL'],
